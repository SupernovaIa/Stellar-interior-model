...
![Total relative error as a function of the central temperature, with a clear
minimum near 1.95e7 K](images/error_vs_temperature.png)
...
![Normalized interior profiles of the best-fit model vs normalized radius, with
the convective/radiative transition layer marked](images/profiles.png)
...
The two figures above are regenerated by
[`scripts/generate_docs_figures.py`](../scripts/generate_docs_figures.py):
